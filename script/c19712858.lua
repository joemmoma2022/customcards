...
function s.initial_effect(c)
    ...
    -- Add Counters passively on Synchro Summon
    ...
    -- Activate Effect: Remove Counter for Special Summon or Send to GY
...
-- Condition: This card was Synchro Summoned
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
    ...
    if sel==0 then
        -- Rabbit Effect: Special Summon up to 2 from GY
        ...
        -- Tank Effect: Send up to 2 opponent cards on the field to GY
